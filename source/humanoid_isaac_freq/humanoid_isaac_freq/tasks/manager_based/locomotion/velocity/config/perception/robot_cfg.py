"""12-DoF YMBOY articulation used by the migrated perception task."""

import isaaclab.sim as sim_utils
from isaaclab.actuators import ImplicitActuatorCfg
from isaaclab.assets import ArticulationCfg

from humanoid_isaac_freq.assets import HUMANOID_ISAAC_FREQ_DATA_DIR
...
YMBOT_BOY_URDF_12DOF_NOARM_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        asset_path=str(
            HUMANOID_ISAAC_FREQ_DATA_DIR / "Robots/ymboy-12dof/ymboy_12dof_no_arm.urdf"
        ),
        fix_base=False,
